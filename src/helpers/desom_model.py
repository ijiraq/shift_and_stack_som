...
RETURNS:
    - Loaded DESOM model
'''
def load_desom_trained(map_size, ae_type, input_dims, ae_path, model_path, latent_dim=32):

    encoder_dims = [input_dims]
    som = DESOM(encoder_dims= encoder_dims, ae_type = ae_type, map_size = map_size , latent_dim=latent_dim)
