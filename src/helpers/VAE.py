...
default_savedir = os.path.join(current_path,'results/vae/')
...
class VAE(object):
    ...
    '''
    def __init__(self, input_dims, inter_1, inter_2,  latent_dims):
        #------------------------ Encoder -------------------
        ...
        #Latent layer
        z_mu = Dense(units = latent_dims, name ='Mu')(h2)
        z_log_sigma = Dense(units = latent_dims, name ='Sigma')(h2)
        ...
        h_decoded2 = decoder_h2(d_i)    #Intermediate reconstruction
